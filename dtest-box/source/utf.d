...
auto towchar( string s ) nothrow // char_t*
{
    import std.utf : toUTF16;

    try                        { return s.toUTF16; }
    catch ( UTFException e )   { return "ERR".toUTF16; }
    catch ( Exception e )      { return "ERR".toUTF16; }
}


//wchar[] towchar( string s ) nothrow // char_t*
//{
//    import std.utf : toUTF16;

//    wchar[] result;

//    try                        { result.length = s.length + 1; result[ 0 .. s.length ] = s.toUTF16; return result; }
//    catch ( UTFException e )   { s = "ERR"; result[ 0 .. s.length ] = s.toUTF16; return result; }
//    catch ( Exception e )      { s = "ERR"; result[ 0 .. s.length ] = s.toUTF16; return result; }
//}
